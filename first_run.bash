...
wget -q "https://dl.fbaipublicfiles.com/MMPT/metaclip/l14_400m.pt" 

echo "Download DFN5B CLIP VIT H 14"
wget https://huggingface.co/apple/DFN5B-CLIP-ViT-H-14/resolve/main/open_clip_pytorch_model.bin?download=true -O "./ckpt/dfn5b_vit_h_14.bin"
echo "Install nltk"
